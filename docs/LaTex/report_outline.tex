...
\begin{figure}[H]
    ...
    \fbox{\parbox{0.85\textwidth}{\centering\vspace{2.5cm}
      ...
      Production monitoring interface with KPIs, visualizations,\\
      batch analysis, and report generation modules.
    \vspace{2.5cm}}}
    \caption{Streamlit dashboard main interface showing real-time 
    production monitoring, quality metrics, and interactive visualizations.}
    \label{fig:dashboard}
\end{figure}
